            ...
            <div className="relative p-1 w-full max-w-xl max-h-full">
                <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5 text-center">
                        ...
                        <button
                            type="button"
                            className='mt-2 border  focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 border-gray-600 text-gray-100 hover:text-gray-200 bg-gray-500 hover:bg-gray-600 disabled:bg-gray-700 focus:ring-gray-800'
